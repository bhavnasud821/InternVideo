...
# Job parameters
JOB_NAME='full_tuning_B_model_18_yolo_crops_new_spatial_augmentation_with_translate_and_random_crop_0.5_scale'
...
python run_finetuning.py \
    ...
    # --min_padding_ratio_positive 0.2 \
    # --max_padding_ratio_positive 1.0 \
    # --min_padding_ratio_negative 0.2 \
    # --max_padding_ratio_negative 0.5
