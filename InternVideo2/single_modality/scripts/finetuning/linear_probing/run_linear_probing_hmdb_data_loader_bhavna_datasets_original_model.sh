...
# Job parameters
JOB_NAME='linear_probing_B_model_hmdb_data_loader_bhavna_datasets_singlelabel_cleaned_larger_including_negative_category_higher_internal_weight_original_model'
...
MODEL_PATH='/home/saumya/pytorch_model_distilled_B14_original.bin'    # Path to pretrained checkpoint
