...
# Job parameters
JOB_NAME='attentive_probing_1B_model_8_frames_31_v2_yolo_crops'
...
python run_linear_probing.py \
    ...
    --train_anno_path /home/saumya/internal_vids/train_bhavna_singlelabel_with_negative_31_v2.csv \
